...
export default {
  ...
  computed:{
    columns(){
      return [ 
        { label: '字段编码', prop: 'fieldCode',width: 100, required: true, tableVisible: true, span:24, },
        { label: '字段名称', prop: 'fieldName', required: true, width: 100, tableVisible: true, span:24,  },
        { label: '字段值类型', prop: 'fieldType',formType: 'radio',required: true, options: this.dict.type.equipment_attribute_filed, width: 200, tableVisible: true, span:24, },
        { label: '取值路径', prop: 'valuePath',width: 100,  tableVisible: true, span:24, },
        { label: '组件类型', prop: 'componentType',formType: 'radio',required: true, options: this.dict.type.equipment_attribute_assembly, width: 100, tableVisible: true, span:24, },
        { label: '组件内容', prop: 'componentContent',width: 100, tableVisible: true, span:24, },
        { label: '是否必填', prop: 'required',formType: 'radio',required: true, options: this.dict.type.equipment_attribute_must,  width: 100, tableVisible: true, span:24, },
        { label: '是否可修改', prop: 'isModify',formType: 'radio',required: true, options: this.dict.type.equipment_attribute_int, width: 100, tableVisible: true, span:24, },
        { label: '备注', prop: 'remark',width: 100, tableVisible: true, span:24, },
        // { label: '启用状态', prop: 'disabled',formType: 'radio',required: true, options: this.dict.type.equipment_attribute_use,width: 100, tableVisible: true, span:24, },
  ...
  data() {
    return {
      ...
      //   { label: '字段编码', prop: 'fieldCode',width: 100, required: true, tableVisible: true, span:24, },
      //   { label: '字段名称', prop: 'fieldName', required: true, width: 100, tableVisible: true, span:24,  },
      //   { label: '字段值类型', prop: 'fieldType',formType: 'radio',required: true, options: [], width: 200, tableVisible: true, span:24, },
      //   { label: '取值路径', prop: 'valuePath',width: 100,  tableVisible: true, span:24, },
      //   { label: '组件类型', prop: 'componentType',formType: 'radio',required: true, options: [], width: 100, tableVisible: true, span:24, },
      //   { label: '组件内容', prop: 'componentContent',width: 100, tableVisible: true, span:24, },
      //   { label: '是否必填', prop: 'REQUIRED',formType: 'radio',required: true, options: [],  width: 100, tableVisible: true, span:24, },
      //   { label: '是否可修改', prop: 'isModify',formType: 'radio',required: true, options: [], width: 100, tableVisible: true, span:24, },
      //   { label: '备注', prop: 'remark',width: 100, tableVisible: true, span:24, },
      //   { label: '启用状态', prop: 'DISABLED',formType: 'radio',required: true, options: [],width: 100, tableVisible: true, span:24, },
      //   { label: '更新时间', prop: 'updateTime',width: 100, tableVisible: true, span:24, formVisible:false, },
      // ],
      // 是否显示弹出层
      open: false,
