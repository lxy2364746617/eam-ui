  ...
  <div>
    ...
    <p class="subtitle"><i class="el-icon-magic-stick"></i> 常规数据
      <span v-if="disabled2" class="rightbutton">
        <el-button v-if="!isReadonly" type="text" icon="el-icon-edit" @click="disabled2=false" v-hasPermi="['equipment:base:modify']">编辑</el-button>
      </span>
      <span v-else class="rightbutton">
    ...
    <p class="subtitle"><i class="el-icon-magic-stick"></i> 财务数据
      <span v-if="disabled3" class="rightbutton">
        <el-button v-if="!isReadonly" type="text" icon="el-icon-edit" @click="disabled3=false" v-hasPermi="['equipment:base:modify']">编辑</el-button>
      </span>
      <span v-else class="rightbutton">
    ...
    <p class="subtitle"><i class="el-icon-magic-stick"></i> 购置数据
      <span v-if="disabled4" class="rightbutton">
        <el-button v-if="!isReadonly" type="text" icon="el-icon-edit" @click="disabled4=false" v-hasPermi="['equipment:base:modify']">编辑</el-button>
      </span>
      <span v-else class="rightbutton">
    ...
    <el-drawer
      ...
      <parentdevice @submitRadio="submitRadio" @close="close" :isDeviceStep1='true' :deviceId='formData.deviceId' @before-close='close'></parentdevice>
    </el-drawer>
  </div>
</template>
