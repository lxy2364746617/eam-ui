<template>
    <div class="card">
        ...
        <el-row :gutter="24">
            <el-form ref="elForm" :model="formData" class="form" :rules="rules" size="medium" label-width="100px">
                <el-col :span="6">
                    <el-form-item label="计划名称" prop="field102">
                        <el-input v-if="isEdit" v-model="formData.field102" placeholder="请输入" clearable :style="{ width: '100%' }">
                        </el-input>
                        <span v-else-if="!isEdit">测试测试测试</span>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="计划类型" prop="field103">
                        <el-select v-if="isEdit" v-model="formData.field103" placeholder="请选择" clearable :style="{ width: '100%' }">
                ...
                <el-col :span="6">
                    <el-form-item label="年度" prop="field104">
                        <el-select v-if="isEdit" v-model="formData.field104" placeholder="请选择" clearable :style="{ width: '100%' }">
                ...
                <el-col :span="6">
                    <el-form-item label="开竣工时间" prop="field105">
                        <el-date-picker v-if="isEdit" type="daterange" v-model="formData.field105" format="yyyy-MM-dd"
