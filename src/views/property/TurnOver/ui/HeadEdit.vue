  ...
  <div :class="[!isEdit ? 'card bgc' : 'card']">
    ...
    <el-row :gutter="24">
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="移交单编号" prop="backNo">
          <el-input
            v-if="isEdit"
        ...
        <el-form-item label="业务日期" prop="transferDate">
          <el-date-picker
            v-if="isEdit"
            ...
            clearable
          ></el-date-picker>
          <span v-else-if="!isEdit">{{ formData2.transferDate }}</span>
        </el-form-item>
        ...
        <el-form-item label="调出部门" prop="outDeptId">
          ...
          <span v-else-if="!isEdit">{{ formData2.outDept }}</span>
        </el-form-item>
        <el-form-item
          label="调出部门负责人"
          prop="outDeptPerson"
