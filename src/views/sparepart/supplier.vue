...
export default {
  name: "Template",
  dicts: [
    "system_supplier_level",
    "system_supplier_type",
    "system_supplier_statue",
  ],
  components: { ContTable, JmForm, child, fileImport },
  computed: {
    // 列信息
    columns() {
      return [
        ...
        { label: "简码", prop: "simpleCode", span: 24 },
        {
          ...
          prop: "supplierLevel",
          formType: "select",
          options: this.dict.type.system_supplier_level,
          required: true,
          span: 24,
        },
        {
          ...
          prop: "supplierType",
          formType: "select",
          options: this.dict.type.system_supplier_type,
          required: true,
          span: 24,
        },
        ...
        },
        {
          ...
          prop: "city",
          formType: "select",
          options: this.cities[this.formData.province] || [],
          span: 24,
        },
        { label: "备注", prop: "remark", formType: "textarea", span: 24 },
        {
          ...
          prop: "supplierStatue",
          formType: "switch",
          options: this.dict.type.system_supplier_statue,
          span: 24,
          formVisible: false,
        },
        {
          label: "所属组织",
          prop: "supplierOrganization",
          span: 24,
          formVisible: false,
        },
    ...
    tablecolumns() {
      return [
        ...
        },
        {
          ...
          prop: "city",
          formType: "select",
          options: this.cities[this.tableprovs] || [],
          span: 24,
        },
        { label: "备注", prop: "remark", formType: "textarea", span: 24 },
        {
    ...
    return {
      ...
      cities: {
        ...
        山西: [
          ...
          { label: "长治市", value: "长治市" },
          { label: "晋城市", value: "晋城市" },
          { label: "忻州地区", value: "忻州地区" },
          { label: "吕梁地区", value: "吕梁地区" },
          { label: "晋中市", value: "晋中市" },
          { label: "临汾地区", value: "临汾地区" },
          { label: "运城地区", value: "运城地区" },
        ],
        北京: [
          { label: "东城区", value: "东城区" },
          { label: "西城区", value: "西城区" },
        ...
        天津: [
          { label: "天津市区", value: "天津市区" },
          { label: "天津市辖区", value: "天津市辖区" },
        ],
        重庆: [
          { label: "重庆市区", value: "重庆市区" },
          { label: "重庆市辖区", value: "重庆市辖区" },
        ],
        辽宁: [
          { label: "沈阳市", value: "沈阳市" },
          { label: "大连市", value: "大连市" },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除设备平台_表单模板编号为"' + ids + '"的数据项？')
        .then(function () {
