      ...
      <jm-table :tableData="templateList" @getList="getList" @handleSelectionChange="handleSelectionChange"
        ...
        <template slot="headerLeft">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
              v-hasPermi="['equipment:gas:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-upload2" size="mini" @click="handleImport"
              v-hasPermi="['equipment:gas:import']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport"
              v-hasPermi="['equipment:gas:export']">下载</el-button>
          </el-col>
          <!-- <el-col :span="1.5">
                    <el-button
                      type="primary"
        ...
        <template #end_handle="scope">
          ...
          <el-button
                    ...
                    v-hasPermi="['equipment:gas:remove']"
                  >删除</el-button>
          <el-button
                    size="mini"
                    type="text"
                    ...
                    @click="handleUpdate(scope.row,'view')"
                    v-hasPermi="['equipment:gas:query']"
                  >查看详情</el-button>
        </template>
      </jm-table>
...
export default {
  ...
  methods: {
    ...
    /** 新增按钮操作 */
    handleAdd() {
      this.$router.push({ path: '/device/big/gas/add', })
      // this.reset();
      // this.drawer = true;
      // this.title = "新增表单模板";
    },
    ...
    handleUpdate(row, state) {
      ...
      this.$router.push({ path: '/device/big/gas/add', query: {l: row.largeId, d: this.disabled }})
      // this.drawer = true;
      // });
    },
    /** 提交按钮 */
