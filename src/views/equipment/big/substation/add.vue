...
{ label:"变电所名称", prop:"substationName", span: 8,required: true, },
{ label:"电源上级站(所)名称", prop:"topSubstationName", span: 8, required: true,},
...
{ label:"具备无人值守条件(是/否)", prop:"unmanned", span: 8, formType: "select", options: this.dict.type.equipment_common_sf, },//(是/否)
    ...
    methods: {
        ...
        getDetails(queryParams) {
            this.loading = true;
            getSubstation(queryParams).then(response => {
