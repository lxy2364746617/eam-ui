...
export default {
    name: "Template",
    dicts: ['em_device_state', 'em_device_level','equipment_large_have','equipment_large_base','equipment_large_switch','equipment_passengers_common','equipment_passengers_oil','equipment_passengers_protect','equipment_elevator_people'],
    ...
    computed: {
        ...
        columns() {
            return [
                ...
                { label:"架空成人装置共谱情况", prop:"common", span: 8, formType: "select", options: this.dict.type.equipment_passengers_common, },//(皮带/轿车)
                ...
                { label:"断轴保护措施", prop:"breakProtect", span: 8, formType: "select", options: this.dict.type.equipment_passengers_protect, },//(0-有,1-无.)
