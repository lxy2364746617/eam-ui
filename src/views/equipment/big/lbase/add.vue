...
export default {
    name: "Template",
    dicts: ['em_device_state', 'em_device_level','equipment_common_yw','equipment_large_base','equipment_common_sf','equipment_common_sf',
    'equipment_generatrix_form'],
    ...
    computed: {
        ...
        tablecolumns() {
            return [
                ...
                { label: "设备类别", prop: "categoryId", formType: 'selectTree', options: this.categoryOptions,width:180 },
