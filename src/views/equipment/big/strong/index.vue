      ...
      <jm-table :tableData="templateList" @getList="getList" @handleSelectionChange="handleSelectionChange"
        ...
        <template slot="headerLeft">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
              v-hasPermi="['equipment:strong:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-upload2" size="mini" @click="handleImport"
              v-hasPermi="['equipment:strong:import']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport"
              v-hasPermi="['equipment:strong:export']">下载</el-button>
          </el-col>
          <!-- <el-col :span="1.5">
                    <el-button
                      type="primary"
        ...
        <template #end_handle="scope">
          ...
          <el-button
                    ...
                    v-hasPermi="['equipment:strong:remove']"
                  >删除</el-button>
          <el-button
                    size="mini"
                    type="text"
                    ...
                    @click="handleUpdate(scope.row,'view')"
                    v-hasPermi="['equipment:strong:query']"
                  >查看详情</el-button>
        </template>
      </jm-table>
...
export default {
  ...
  methods: {
    ...
    saveHandle2() {
      ...
      importStrong(this.importData).then(response => {
        loading.close();
    ...
    submitForm: function (formdata) {
      if (formdata.id != undefined) {
        updateStrong(formdata).then(response => {
          this.$modal.msgSuccess("修改成功");
          this.drawer = false;
          this.getList();
        });
      } else {
        addStrong(formdata).then(response => {
