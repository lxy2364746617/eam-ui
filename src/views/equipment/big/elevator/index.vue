      ...
      <jm-table :tableData="templateList" @getList="getList" @handleSelectionChange="handleSelectionChange"
        ...
        <template slot="headerLeft">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
              v-hasPermi="['equipment:elevator:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-upload2" size="mini" @click="handleImport"
              v-hasPermi="['equipment:elevator:import']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport"
              v-hasPermi="['equipment:elevator:export']">下载</el-button>
          </el-col>
          <!-- <el-col :span="1.5">
                    <el-button
                      type="primary"
        ...
        <template #end_handle="scope">
          ...
          <el-button
                    ...
                    v-hasPermi="['equipment:elevator:edit']"
                    >编辑</el-button>
          <el-button
                    size="mini"
                    type="text"
                    ...
                    v-hasPermi="['equipment:elevator:remove']"
                  >删除</el-button>
          <el-button
                    size="mini"
                    type="text"
                    ...
                    @click="handleUpdate(scope.row,'view')"
                    v-hasPermi="['equipment:elevator:query']"
                  >查看详情</el-button>
        </template>
      </jm-table>
...
export default {
  ...
  methods: {
    ...
    getList(queryParams) {
      this.loading = true;
      listElevator(queryParams).then(response => {
