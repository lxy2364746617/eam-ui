    ...
    computed: {
        ...
        columns() {
            return [
                ...
                { label:"矿井涌水量正常(m³/h)", prop:"gushWater", span: 8, },
                { label:"矿井涌水量最大(m³/h)", prop:"maxWater", span: 8, },
{ label:"泵房名称", prop:"waterName", span: 8, },
{ label:"泵房类型", prop:"waterType", span: 8, },
...
{ label:"具备无人值守条件(是/否)", prop:"unmanned", span: 8, formType: "select", options: this.dict.type.equipment_common_sf, },
    ...
    methods: {
        ...
        getDetails(queryParams) {
            this.loading = true;
            getWater(queryParams).then(response => {
