      ...
      <jm-table :tableData="templateList" @getList="getList" @handleSelectionChange="handleSelectionChange"
        ...
        <template slot="headerLeft">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
              v-hasPermi="['equipment:water:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-upload2" size="mini" @click="handleImport"
              v-hasPermi="['equipment:water:add']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport"
              v-hasPermi="['equipment:water:add']">下载</el-button>
          </el-col>
          <!-- <el-col :span="1.5">
                    <el-button
                      type="primary"
        ...
        <template #end_handle="scope">
          ...
          <el-button
                    ...
                    v-hasPermi="['equipment:water:remove']"
                  >删除</el-button>
          <el-button
                    size="mini"
                    type="text"
...
export default {
  ...
  methods: {
    ...
    saveHandle2() {
      ...
      importWater(this.importData).then(response => {
        loading.close();
    ...
    /** 新增按钮操作 */
    handleAdd() {
      this.$router.push({ path: '/device/big/water/add', })
      // this.reset();
      // this.drawer = true;
      // this.title = "新增表单模板";
    },
    ...
    handleUpdate(row, state) {
      ...
      this.$router.push({ path: '/device/big/water/add', query: {l: row.largeId, d: this.disabled }})
      // this.drawer = true;
      // });
    },
    /** 提交按钮 */
