...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        { label:"文件名称", prop:"originalFileName", tableVisible: true, span: 12, required: true, },
        { label:"上传时间", prop:"createTime", formType: 'date', tableVisible: true, span: 12, required: true, },
        { label:"上传人员", prop:"createBy", tableVisible: true, span: 12, required: true, },
        { label:"文件大小", prop:"fileSize", tableVisible: true, span: 12, required: true, },
      ],
      disabled1: true,
      disabled2: true,
      // 遮罩层
