<template>
  <div>
    <el-card shadow="never" style="margin-top: 10px;">
      <div v-if="formData.archivesIndexList!=null">
        <p><i class="el-icon-magic-stick"></i> 主要指标</p>
        <jm-form 
          class="mr20"
          :columns="formData.archivesIndexList.componentContent" 
          :showButton="false"
          :formData="formData.archivesIndexList.fieldValue"
          ref="jmform3">
        </jm-form>
      </div>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    getFormDataParams(){
      ...
      var aa = formData.archivesIndexList
