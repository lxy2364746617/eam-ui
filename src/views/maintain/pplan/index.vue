  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="巡点检类型" prop="itemType">
        <el-select v-model="queryParams.itemType" placeholder="请选择巡点检类型" clearable>
          <el-option
      ...
      <el-form-item label="巡点检周期" prop="planCycle">
        <el-input
          ...
          placeholder="请输入巡点检周期"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="巡点检周期类别" prop="planCycleType">
        <el-select v-model="queryParams.planCycleType" placeholder="请选择巡点检周期类别" clearable>
          <el-option
            v-for="dict in dict.type.mro_plan_cycle_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['maintain:pplan:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['maintain:pplan:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['maintain:pplan:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="pplanList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" align="center" prop="planId" v-if="false" />
      <el-table-column label="序号" align="center" />
      <el-table-column label="巡点检计划编码" align="center" prop="planCode" />
      <el-table-column label="巡点检计划名称" align="center" prop="planName" />
      ...
      <el-table-column label="巡点检类型" align="center" prop="itemType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.mro_item_type" :value="scope.row.itemType" />
        </template>
      </el-table-column>
      <el-table-column label="周期" align="center" prop="planCycle" />
      <el-table-column label="巡点检周期类别" align="center" prop="planCycleType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.mro_plan_cycle_type" :value="scope.row.planCycleType" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="巡点检班组" align="center" prop="groupId" />
      <el-table-column label="巡点检执行人" align="center" prop="executor" />
      <el-table-column label="巡点检负责人" align="center" prop="director" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="巡点检计划名称" prop="planName">
          <el-input v-model="form.planName" placeholder="请输入巡点检计划名称" />
        </el-form-item>
        <el-form-item label="计划状态" prop="planStatus">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listPplan(this.queryParams).then((response) => {
