  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="是否特种设备" prop="isSpecial">
        <el-select v-model="queryParams.isSpecial" placeholder="请选择是否特种设备" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['maintain:standard:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['maintain:standard:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="standardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键" align="center" prop="standardId" hidden />
      <el-table-column label="序号" align="center" prop="standardId" hidden />
