<template>
  <div class="app-container" style="padding-top: 0;">
    <jm-table :tableData="itemList" @getList="getList" @handleSelectionChange="handleSelectionChange" :total="total"
      ref="jmtable"  :columns="columns" :isRadio="isChoose">
    ...
    <el-dialog :visible='lineView' :before-close="()=>{lineView=false}" :close-on-click-modal='false' width='900px'
      append-to-body>
      <div class="title">保养路线名称</div>
        <el-form ref="form" :model="form"  label-width="90px" size="small" style="margin: 10px auto;">
            <el-row :gutter="10" style="padding: 0 20px;">
                ...
                <el-col :span="8">
                    <el-form-item label="路线名称" prop="lineName">
                        <el-input v-model="form.lineName" placeholder="请输入路线名称" disabled />
                    </el-form-item></el-col>
                <el-col :span="8">
                    <el-form-item label="状态" prop="lineStatus">
                        <el-select v-model="form.lineStatus" placeholder="请选择状态" disabled>
        ...
        <el-table  :data="mlineList"  ref="queryTable"
            ...
            <el-table-column label="日常保养" align="center" prop="dayNum" min-width="150"></el-table-column>
            <el-table-column label="一级保养" align="center" prop="oNum" min-width="150"></el-table-column>
            <el-table-column label="二级保养" align="center" prop="tNum" min-width="150"></el-table-column>
            <el-table-column label="常规润滑" align="center" prop="cNum" min-width="150"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleView(row){
      this.loading = false;
      getMline(row.lineId).then(response => {
