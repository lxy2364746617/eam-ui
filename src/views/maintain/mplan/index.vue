  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="保养周期类别" prop="planCycleType">
        <el-select v-model="queryParams.planCycleType" placeholder="请选择保养周期类别" clearable>
          <el-option
            v-for="dict in dict.type.mro_m_cycle_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="保养执行人" prop="executor">
        <el-input
          v-model="queryParams.executor"
          placeholder="请输入保养执行人"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="其他执行人" prop="otherExecutor">
        <el-input
          v-model="queryParams.otherExecutor"
          placeholder="请输入其他执行人"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['maintain:mplan:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['maintain:mplan:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="mplanList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" align="center" prop="planId" v-if="false" />
      ...
      <el-table-column label="保养周期" align="center" prop="planCycle" />
      <el-table-column label="保养周期类别" align="center" prop="planCycleType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.mro_m_cycle_type" :value="scope.row.planCycleType" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="保养班组" align="center" prop="groupId" />
      <el-table-column label="保养执行人" align="center" prop="executor" />
      <el-table-column label="保养负责人" align="center" prop="director" />
      <el-table-column label="其他执行人" align="center" prop="otherExecutor" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="保养计划编码" prop="planCode">
          <el-input v-model="form.planCode" placeholder="请输入保养计划编码" />
        </el-form-item>
        <el-form-item label="保养计划名称" prop="planName">
        ...
        <el-form-item label="保养周期" prop="planCycle">
          <el-input v-model="form.planCycle" placeholder="请输入保养周期" />
        </el-form-item>
        <el-form-item label="保养周期类别" prop="planCycleType">
        ...
        <el-form-item label="保养班组" prop="groupId">
          <el-input v-model="form.groupId" placeholder="请输入保养班组" />
        </el-form-item>
        <el-form-item label="保养执行人" prop="executor">
          <el-input v-model="form.executor" placeholder="请输入保养执行人" />
        </el-form-item>
        <el-form-item label="保养负责人" prop="director">
          <el-input v-model="form.director" placeholder="请输入保养负责人" />
        </el-form-item>
        <el-form-item label="其他执行人" prop="otherExecutor">
...
export default {
  name: 'Mplan',
  dicts: ['mro_m_cycle_type', 'mro_m_item_type', 'sys_normal_disable'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listMplan(this.queryParams).then((response) => {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除保养检修计划编号为"' + planIds + '"的数据项？')
        .then(function () {
